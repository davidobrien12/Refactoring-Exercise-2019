...
public class EmployeeDetails extends JFrame implements ActionListener, ItemListener, DocumentListener, WindowListener {
	...
	// creating vector of vectors. this holds all employee details
	...
	//checking if there is any records in the file that are active
	...
	//allows changes to be saved when exiting app
